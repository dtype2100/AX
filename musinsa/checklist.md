...
- [ ] Define the merchandising/data situation and public evidence.
- [ ] Write the problem statement and why it was selected.
- [ ] Define one core workflow: brand/product/trend inputs to MD questions, hypotheses, decision options, and risk notes.
- [ ] Define plugin name, skill name, sample prompt, and expected output.

## 3. Build And Verify

- [ ] Create `musinsa/src/.codex-plugin/plugin.json`.
- [ ] Create `musinsa/src/skills/<name>/SKILL.md`.
- [ ] Draft `musinsa/README.md` with the five required answers.
